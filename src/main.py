...
if __name__=="__main__":
    ...
    parser.add_argument('--model_path', type=str, required=True, help="The pre-trained BERT checkpoint to fine-tune.")
    ...
    parser.add_argument('--max_len', type=int, default=256, help="The maxmium length of each input.")
    ...
    parser.add_argument('--eval_batch_size', type=int, default=16, help="The batch size for evaluation.")
    ...
    parser.add_argument('--max_grad_norm', type=float, default=1.0, help="The maximum value for gradient clipping.")
